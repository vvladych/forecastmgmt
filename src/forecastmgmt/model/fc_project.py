...
class FcProject(MDO):
    sql_dict={  "insert":"INSERT INTO fc_forecast(common_name) VALUES(%s) RETURNING sid",
                ...
                "load":"SELECT forecast_uuid,common_name,created_date FROM fc_forecast WHERE sid=%s"}
